...
var SubtractControls = React.createClass({displayName: "SubtractControls",
	...
	render: function() {
		return React.createElement("li", {className: "counter-button", onClick: this.props.onClick(this.props.buttonIndex)}, this.props.buttonInt)
	}
});
...
var Counter = React.createClass({displayName: "Counter",
	...
	render: function() {
		return React.createElement("div", null, 
			   	...
			   	React.createElement("div", null, React.createElement(AddButtons, {onClick: this.onAdd})), 
