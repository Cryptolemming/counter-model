...
var SubtractControls = React.createClass({displayName: "SubtractControls",
	...
	render: function() {
		...
		return React.createElement("button", {className: "counter-button", onClick: this.onClickHandler, style: styling}, this.props.buttonIndex)
	}
});
...
var Counter = React.createClass({displayName: "Counter",
	...
	render: function() {
		return React.createElement("div", null, 
			   	...
			   	React.createElement(SubtractButtons, {onClick: this.state.buttonList}), 
